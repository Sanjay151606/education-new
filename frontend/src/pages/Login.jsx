    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 w-full max-w-md space-y-6">
        <div className="text-center space-y-1">
          ...
          <p className="text-sm text-slate-500">Sign in to your BrainGraph account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/forgot-password"
                className="text-xs text-brain-600 hover:text-brain-700 font-medium transition"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-sm text-center text-slate-500">
          ...
          <Link to="/register" className="text-brain-600 hover:text-brain-700 font-semibold">
            Sign up
          </Link>
        </p>
      </div>
